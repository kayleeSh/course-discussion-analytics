// copy from pages/InstructorDashboard.js
...
import TopicPostCountChart from './TopicPostCountChart';
...
import MonthlyPostTrendChart from './MonthlyPostTrendChart';
import CourseTopicCountChart from './CourseTopicCountChart';
...
function InstructorDashboard() {
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => {
        console.error('Get course data failed：', err);
      })
      .finally(() => {
        setLoading(false);
      });
